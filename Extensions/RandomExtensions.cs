...
namespace Frozen
{
	public static class RandomExtensions
	{
		...
		public static Vector2 NextVector2(this Random r, Rectangle rect)
		{
			return new Vector2(r.NextFloat(rect.X, rect.X + rect.Width), r.NextFloat(rect.Y, rect.Y + rect.Height));
		}
		...
		public static Vector3 NextVector3(this Random r)
		{
			...
			rot *= Quaternion.CreateFromAxisAngle(Vector3.UnitZ, r.NextFloat(MathHelper.TwoPi));
			rot *= Quaternion.CreateFromAxisAngle(Vector3.UnitX, r.NextFloat(MathHelper.TwoPi));
